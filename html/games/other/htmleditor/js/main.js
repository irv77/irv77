...
buttonMenu.innerHTML =
  '<svg width="8" height="8"><path d="M 0,1.5 8,1.5 M 0,4.5 8,4.5 M 0,7.5 8,7.5"></svg>';
...
var popup = (function () {
  ...
  var buttonClose = (function () {
    ...
    path.setAttribute(
      "d",
      "M 9,12 L 11,10 L 15,14 L 19,10 L 21,12 L 17,16 L 21,20 L 19,22 L 15,18 L 11,22 L 9,20 L 13,16"
    );
...
function validate(value) {
  return codemirror.operation(function () {
    ...
    while (
      ...
      lines[lineCurrent].indexOf("<script>") === -1
    ) {
      string += "\n";
      lineCurrent++;
    }
